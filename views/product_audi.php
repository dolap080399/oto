<?php 
	$sql = "SELECT count(id_product) as total from product WHERE id_trademark=9";
 ...
 ?>
					<div class="title_product">Thương hiệu Audi</div>
					<?php 
					$result = "SELECT id_product,name_product,price,img_product FROM product WHERE id_trademark=9 LIMIT $start,$limit ";
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a style="color:white;font-weight: bold;padding:0 7px;" href="index.php?page=product_audi&page_pt='.($current_page-1).'">Prev</a> | ';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    ...
                    echo '<a style="color:#F7EBEB;font-weight: bold;padding:0 7px;" href="index.php?page=product_audi&page_pt='.$i.'">'.$i.'</a> | ';
                }
            }
 
            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
            if ($current_page < $total_page && $total_page > 1){
                echo '<a style="color:white;font-weight: bold;padding:0 7px;" href="index.php?page=product_audi&page_pt='.($current_page+1).'">Next</a>  ';
            }
           ?>
           </div>
